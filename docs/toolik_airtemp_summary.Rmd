...
```{r}
toolik_mean_temp_jitter <- ggplot(data = toolik_weather, aes(x = month, y = daily_air_temp_mean_c)) +
  geom_jitter(aes(color = daily_air_temp_mean_c)) +
  scale_color_gradient(low = "blue", high = "orange") +
  # scale_color_gradient(colors = c("blue", "purple", "red")) +
  theme_minimal() +
...
# ggsave(plot = toolik_mean_temp_jitter, here::here("figs", "toolik_mean_temp_jitter.jpg"), height = 5, width = 6)
```
